...
function Customers() {
    ...
    async function users() {
        const res = await mainservice.users(index);
            ...
            <div className="main main-app p-3 p-lg-4">
                <div className="d-md-flex align-items-center justify-content-between mb-4">
                    <div>
                        ...
                        <h4 className="main-title mb-0">Customers List</h4>
                    </div>
                                            ...
                                            <Button className='p-0' variant="white">
                                                ...
                                                <Dropdown drop="end">
                                                    ...
                                                    <Dropdown.Menu>
                                                        ...
                                                        <Dropdown.Item onClick={() => navigate(`/dashboard/admin/Customers/?id=${item._id}`)}>Edit</Dropdown.Item>
