...
function Purchase() {
        ...
        <div className="d-md-flex align-items-center justify-content-between mb-4">
          <div>
            <ol className="breadcrumb fs-sm mb-1">
              ...
              <li className="breadcrumb-item active" aria-current="page">Purchase Managment</li>
            </ol>
            <h4 className="main-title mb-0">Purchase Managment</h4>
          </div>
          <div className="d-flex gap-2 mt-3 mt-md-6">
            <Button variant="primary" className="d-flex align-items-center gap-2" onClick={() => navigate('/dashboard/purchase/AddPurchase')}>
              <i className="ri-bar-chart-2-line fs-18 lh-1"></i>Add Purchase<span className="d-none d-sm-inline"></span>
            </Button>
          </div>
        </div>
 ...
 <h5 id="section13" className="main-subtitle mt-5">Purchase List</h5>
