            ...
            <FullScreen handle={handle}>
                ...
                >
                    <div className="d-flex align-items-center justify-content-between mb-4">
                        <div>
                            <h4 className="main-title mb-0">ECommerce</h4>
                            {!fullScreen && (
                                <>
                                    <ul className="nav">
                                        <li className="nav-item">
                                            <a className="nav-link active" aria-current="page" href="home">Boy Fashion</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link" href="pos">Girl Fashion</a>
                                        </li>
                                        <li className="nav-item">
                    ...
                    {/* category slider using react-slick */}
                    <div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel">
                        <div className="carousel-inner">
                            <div className="carousel-item active">
                                <img src="img/img1.jpg" className="d-block w-100" alt="Carousel Item 1" />
                            </div>
                            <div className="carousel-item">
                                <img src="img/img2.jpg" className="d-block w-100" alt="Carousel Item 2" />
                            </div>
                            <div className="carousel-item">
                                <img src="img/img3.jpg" className="d-block w-100" alt="Carousel Item 3" />
                            </div>
                        </div>
